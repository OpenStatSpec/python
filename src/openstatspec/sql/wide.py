...
def catalog(metadata: MetaData) -> tuple[Table, Table, Table, Table]:
    datasets = Table(
        ...
        Column("source_name", lossless_text_type(), nullable=False),
        Column("source_table_name", lossless_text_type()),
        ...
        Column("file_label", lossless_text_type(), nullable=False, default=""),
        Column("documents", lossless_text_type(), nullable=False, default="[]"),
        Column("file_attributes", lossless_text_type(), nullable=False, default="{}"),
        Column("case_weight_variable", String(255)),
        Column("multiple_response_sets", lossless_text_type(), nullable=False, default="{}"),
    )
    variables = Table(
        ...
        Column("label", lossless_text_type(), nullable=False, default=""),
        ...
        Column("attributes", lossless_text_type(), nullable=False, default="{}"),
        Column("compat_name", String(255)),
        Column("value_labels", lossless_text_type(), nullable=False, default="{}"),
        Column("missing_ranges", lossless_text_type(), nullable=False, default="[]"),
    )
    fidelity_events = Table(
        ...
        Column("detail", lossless_text_type(), nullable=False),
        Column("details", lossless_text_type(), nullable=False, default="{}"),
    ...
    operations = Table(
        ...
        Column("dataset_id", String(255)),
        Column("source", lossless_text_type()),
        Column("destination", lossless_text_type()),
...
def _migrate_catalog_columns(
    ...
    text_declaration = str(
        lossless_text_type().compile(dialect=connection.dialect)
    )
    additions = {
        datasets.name: {
...
def source_extension_catalog(metadata: MetaData) -> Table:
    ...
    return Table(
        ...
        Column("payload", lossless_text_type(), nullable=False),
    )
...
def document_catalog(metadata: MetaData) -> Table:
    ...
    return Table(
        ...
        Column("dataset_id", String(255), primary_key=True),
        Column("ordinal", Integer, primary_key=True),
        Column("text", lossless_text_type(), nullable=False),
    )
...
def value_label_catalog(metadata: MetaData) -> Table:
    ...
    return Table(
        ...
        Column("text_value", lossless_text_type()),
...
def create_wide_dataset(
    *, database_url: str, dataset_id: str, source_name: str, source_format: str,
    ...
    data_table = Table(
        ...
        *(Column(
            item["physical_name"],
            binary64_type() if item["storage_kind"] == "numeric" else lossless_text_type(),
