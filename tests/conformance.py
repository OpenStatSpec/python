...
from openstatspec import compare_sav_semantics
...
def write_supported_semantics_fixture(destination: str | Path) -> dict[str, Any]:
    ...
    long_text = "Õ🙂漢字" * 90
    long_text_variable = "long_comment_variable"
    frame = pd.DataFrame({
        ...
        "status": ["NA", "DK", "ok", ""],
        long_text_variable: [long_text, "", "näide", long_text],
    ...
    metadata = {
        "var_types": {"status": 8, long_text_variable: 1024},
        "var_formats": {
            "discrete_missing": "F8.0", "range_only": "F8.0",
            "lowest_range": "F12.1", "highest_range": "F12.1", "code": "F8.0",
            "status": "A8", long_text_variable: "A1024", "interview_date": "DATE11",
        ...
        "var_labels": {
            ...
            long_text_variable: "Long UTF-8 comment", "interview_date": "SPSS numeric date",
        ...
        "var_value_labels": {
            ...
            long_text_variable: {"coded": "Short code in a very-long string variable"},
        },
        "var_missing_values": {
        ...
        "var_measure_levels": {
            ...
            "status": "nominal", long_text_variable: "nominal", "interview_date": "scale",
        },
        "var_alignments": {column: "left" for column in frame.columns},
        "var_column_widths": {
            "discrete_missing": 8, "range_only": 8, "lowest_range": 12, "highest_range": 12,
            "code": 8, "status": 12, long_text_variable: 48, "interview_date": 11,
    ...
    compatible_name = "LCOMM"
    write_compatible_names(
        destination, {long_text_variable: compatible_name}, encoding="UTF-8",
    )
    return {
        "long_text": long_text, "long_text_variable": long_text_variable,
        "compatible_name": compatible_name, "file_label": metadata["file_label"],
    }
